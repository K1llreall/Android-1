package com.example.colordiscriptor;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewDescriptionTemp= findViewById(R.id.textViewDescriptoinTemp);
    }


    public void showDescription(View view) {
        int position= spinnerColors.getSelectedItemPosition();
        String description= getDiscriptionByPosition(position);
        textViewDescriptionTemp.setText(description);

    }
    private String getDiscriptionByPosition (int position){
